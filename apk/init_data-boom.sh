...
time='2023年8月27号'
    [[ $Choice = 1 ]] && Download -boom 'Magisk-v26.2.apk' "$1.apk" '12510158' '70d69b1f05137c3e86135669a578b37b' "$1.apk"
;;
...
description='浏览器'
time='2023年8月30号'
    [[ $Choice = 1 ]] && Download -boom 'Via_4.9.0(20230830).apk' "$1.apk" '1771411' 'a6e60fea8ea9d070abb473bc2e04e54b' "$1.apk"
;;
