...
time='2023年4月5号'
    [[ $Choice = 1 ]] && Download -boom 'Magisk-26.0.apk' "$1.apk" '11399404' '83eca77142529fb3be58cbd0ee17cdcc' "$1.apk"
;;
...
description='系统API授权'
time='2023年4月3号'
    [[ $Choice = 1 ]] && Download -boom 'shizuku-v13.2.1.r989.apk' "$1.apk" '3413976' '980274e0c5e5cebacad4602bd5d5dab7' "$1.apk"
;;
...
time='2023年4月2号'
    ...
    [[ $Choice = 1 ]] && Download -boom 'r-packageinstalles_v2.6.9-beta(297).apk' "$1.apk" '2828176' '0714af66b7c6569a04dd321a653b5baf' "$1.apk"
;;
...
description='冻结软件'
time='2023年3月17号'
    [[ $Choice = 1 ]] && Download -boom 'hail_1.2.2(25).apk' "$1.apk" '2823166' '751668d429b2224545bcec89b349d951' "$1.apk"
;;
...
description='浏览器'
time='2023年4月1号'
    [[ $Choice = 1 ]] && Download -boom 'xbrowser_4.0.1(713).apk' "$1.apk" '1151646' '48a59e177af49f4e700568cf94edbb69' "$1.apk"
;;
