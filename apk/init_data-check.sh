...
time='2023年8月19号'
    [[ $Choice = 1 ]] && Download -url 'https://kgithub.com/EEBBK-BOOM/EEBBK_profile/releases/download/Toolbox/Toolbox.apk' "$1.apk" '17572837' 'ff03fc16aa537969f6346b2bd35fe7b7' "$1.apk"
;;
