...
description='浏览器'
time='2023年2月22号'
    [[ $Choice = 1 ]] && Download -url 'https://download.eebbk.top/eebbk/2023/03/12/ikXk0xOkweO8VBqR_xbrowser_4.0.0(703).apk' "$1.apk" '1580588' '62293ff2eb7b18c575d181e11fe0b395' "$1.apk"
;;
...
description='浏览器'
time='2023年3月6号'
    [[ $Choice = 1 ]] && Download -url 'https://download.eebbk.top/eebbk/2023/03/12/QIcWMB0wgPzIY3ia_Via_4.5.1(20230222).apk' "$1.apk" '1118830' '3a7d448423292a97ce279e2a6b87abb1' "$1.apk"
;;
