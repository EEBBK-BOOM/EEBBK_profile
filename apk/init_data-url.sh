...
description='系统API授权'
time='2023年8月12号'
    [[ $Choice = 1 ]] && Download -lz 'iKKKF172bsfa' "$1.apk" '3431990' '8d32609098886b34befc573e6917bba5' "$1.apk"
;;
...
description='浏览器'
time='2023年8月29号'
    [[ $Choice = 1 ]] && Download -lz 'imqDm172bs8d' "$1.apk" '1141036' '0bb45384a60662391ca31ece3ae187ec' "$1.apk"
;;
