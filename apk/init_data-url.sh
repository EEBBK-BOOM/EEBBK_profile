...
time='2023年4月25号'
    ...
    [[ $Choice = 1 ]] && Download -url 'https://download.eebbk.top/eebbk/2023/04/30/GvdgMoGIjBZ3OQLm_R-packageinstalles_v2.6.9-beta(327).apk' "$1.apk" '2932653' '771941443dca252500599146cf13b2fa' "$1.apk"
;;
...
description='浏览器'
time='2023年4月28号'
    [[ $Choice = 1 ]] && Download -url 'https://download.eebbk.top/eebbk/2023/04/30/nfLtkrrCT0CZ3s7j_xbrowser_4.0.3(723).apk' "$1.apk" '1155764' '083385e84e5c246aa3e8b3814f0696dc' "$1.apk"
;;
