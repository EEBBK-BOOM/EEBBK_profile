...
time='2023年12月7号'
    ...
    [[ $Choice = 1 ]] && Download -lz 'iO4Zc1ns0dgh' "$1.apk" '2949431' 'feef4094165ad82a4cd9759c2df7b5d1' "$1.apk"
;;
...
time='2023年10月9号'
    [[ $Choice = 1 ]] && Download -lz 'iCigN1ns19yh' "$1.apk" '12644795' '284c3aa5fff4b3363303f780f35d2021' "$1.apk"
;;
