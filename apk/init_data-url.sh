...
description='浏览器'
time='2023年2月24号'
    [[ $Choice = 1 ]] && Download -url 'https://download.eebbk.top/eebbk/2023/03/06/ObjNGI6w8gibtQYA_xbrowser_4.0.0(698).apk' "$1.apk" '1119067' '3b83fb63b003c3ac963d7845a999f536' "$1.apk"
;;
